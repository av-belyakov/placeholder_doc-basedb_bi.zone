...
// NewListBiZoneHandlerObservedIocs обработчик для значений типа 'data.observed_iocs.*' основного объекта
func NewListBiZoneHandlerObservedIocs(sst *datamodels.SupportingStructureForTags) map[string][]func(any) {
